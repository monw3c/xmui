...
export default {
  confirm (opts) {
    const defaultOpts = {title: '', content: '', type: 'confirm', maskClosable: true, color: '', confirmText: '确定', cancelText: '取消', callBack () {}, closeAction () {}}
    const propsOpts = Object.assign(defaultOpts, opts)
    return open(propsOpts)
  },

  prompt (opts) {
    const defaultOpts = {title: '', placeholder: '', type: 'prompt', maskClosable: true, color: '', confirmText: '确定', cancelText: '取消', readonly: false, callBack () {}, closeAction () {}}
    const propsOpts = Object.assign(defaultOpts, opts)
    return open(propsOpts)
  },
